...
if(isset($_POST['submit']))
{
	...
	if (($_FILES['img']['type'] == 'image/gif') ||($_FILES['img']['type'] == 'image/png') || ($_FILES['img']['type'] == 'image/jpeg') || ($_FILES['img']['type'] ==  'image/jpg') && ($_FILES['img']['size'] < 1500))
	{
		...
		else if(move_uploaded_file($_FILES['img']['tmp_name'],'../Products/images/'.$_FILES['img']['name']))
		{
			...
			$query=mysqli_query($con,"INSERT INTO `trilo_product_slides`(`image_path`) VALUES('".$part1."')") or die(mysqli_error($con));
...
<div id="page-wrapper">
		...
		<div class="row">
            <div class="col-lg-12">
				...
				<div class="panel-heading">
                    Add Product page slider images 
                </div>
	...
	<form action="" method="POST" enctype="multipart/form-data">
		...
		<div class="row">		
			...
			<label class="form-label col-sm-2">Slider Image :</label>
			<div class="col-sm-7">
...
<?php
$cnt=1;
$sql=@mysqli_query($con,"SELECT * FROM trilo_product_slides") or die(mysqli_error($con));
...
<td>
	<?php echo '<a href="delete.php?prodslideid='.$id.'" style="color:white;" > ';?>
